...
sealed class BottomNavItem(
    ...
    object Board : BottomNavItem("보드", R.drawable.nav_dashboard_unselected, R.drawable.nav_dashboard_selected)
    ...
    object Profile : BottomNavItem("마이", R.drawable.nav_profile_unselected, R.drawable.nav_profile_selected)
