...
class CardUploadService : Service() {
    ...
    private fun createProgressNotification(): Notification {
        val builder =
            NotificationCompat.Builder(this, com.example.nubo.push.PushChannels.CH_UPLOAD_PROGRESS)
    ...
    private fun uploadCard(videoUrl: String, boardId: Long?) {
        val request = CardUploadRequest(videoUrl)

        // Authorization header will be injected by TokenInterceptor
